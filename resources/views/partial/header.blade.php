                        ...
                        <ul class="navbar-nav navbar">
                            <li class="nav-item">
                                <a class="nav-link active" aria-current="page" href="/">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="14.979"
                                        viewBox="0 0 16 14.979">
                                            ...
                                            <g id="_x32__21_" transform="translate(0 19.534)">
                                                <g id="Group_3608" data-name="Group 3608" transform="translate(0 0)">
                                                    <path id="Path_1252" data-name="Path 1252"
                                                        d="M8,33.692,1.066,30.5c.024.014-.613-.273-1.066-.532,0,.387.1,1.1.458,1.286L7.246,34.3a1.446,1.446,0,0,0,1.508,0l6.788-3.052c.335-.156.458-.891.458-1.286-.436.218-1.055.53-1.067.532ZM8,20.373c.05.059.037.012,0,0ZM.458,28.052,7.246,31.1a1.446,1.446,0,0,0,1.508,0l6.788-3.051c.335-.156.458-.89.458-1.286-.436.219-1.055.53-1.067.533L8,30.5,1.066,27.3c.024.015-.613-.274-1.066-.533C0,27.153.1,27.861.458,28.052Zm0-3.2,6.788,3.052a1.446,1.446,0,0,0,1.508,0l6.788-3.052a.935.935,0,0,0,0-1.507L8.754,19.765a1.347,1.347,0,0,0-1.509,0L.458,23.349A.918.918,0,0,0,.458,24.856ZM8,20.373,14.933,24.1,8,27.024,1.066,24.1Z"
                                                        transform="translate(0 -19.534)"></path>
                                                </g>
                                            </g>
                                        </g>
                                    </svg>
                                            ...
                                            <g id="_x38__18_" transform="translate(0 76.5)">
                                                <g id="Group_3685" data-name="Group 3685">
                                                    <path id="Path_1329" data-name="Path 1329"
                                                        d="M8.5,83.5h-6a.5.5,0,0,0,0,1h6a.5.5,0,0,0,0-1Zm0,2h-6a.5.5,0,0,0,0,1h6a.5.5,0,0,0,0-1Zm5.5-9H2a2,2,0,0,0-2,2v8a2,2,0,0,0,2,2H14a2,2,0,0,0,2-2v-8A2,2,0,0,0,14,76.5Zm1,10a1,1,0,0,1-1,1H2a1,1,0,0,1-1-1v-8a1,1,0,0,1,1-1H14a1,1,0,0,1,1,1Zm-2-8H11a1,1,0,0,0-1,1v2a1,1,0,0,0,1,1h2a1,1,0,0,0,1-1v-2A1,1,0,0,0,13,78.5ZM13,81a.5.5,0,0,1-.5.5h-1A.5.5,0,0,1,11,81V80a.5.5,0,0,1,.5-.5h1a.5.5,0,0,1,.5.5Z"
                                                        transform="translate(0 -76.5)"></path>
                                                </g>
                                            </g>
                                        </g>
                                    </svg>
                            ...
                            @if (!auth()->check())
                                ...
                                <li class="nav-item">
                                    <a href="{{ route('user.login') }}" class="nav-link"><svg id="user"
                ...
                <div class="smart-job shadow">
                    ...
                    <div class="input-group mb-3 row shadow filter-serch mt-3">
                        <div class="input-group-text p-0 col-lg-3 col-md-3 col-6">
                            <span toggle="#password-field" class="field-icon toggle-password"><img
                                    src="{{ asset('website/assets/images/location.png') }}" alt=""></span>

                            <select name="country"
                                class="form-select form-select-lg border-0 custom-input-padding form-select-search rounded-0">
                        ...
                        <div class="input-group-text p-0 col-lg-3 col-md-3 col-6">
                            <span toggle="#password-field" class="field-icon toggle-password"><img
                                    src="{{ asset('website/assets/images/label.png') }}" alt=""></span>

                            <select name="specialty"
                                class="form-select form-select-lg border-0 custom-input-padding rounded-0">
                        ...
                        <input type="search" name="title"
                            class="form-control col-lg-5 col-md-5 col-12 custom-input-padding"
                            placeholder="ادخل نص البحث">
                        <button type="button" class="input-group-text btn-1 col-1 text-center search-btn"

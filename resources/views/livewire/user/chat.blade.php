            ...
            <div class="card descripe-project-msg my-1">
                @foreach($users as $user)
                    <div class="card-body cursor-pointer" style="cursor: pointer"
                        ...
                        @if($user->avatar)
                            <img height="40" width="40" class="rounded-circle" src="{{asset('uploads/pics/'. $user->avatar)}}" alt="">
                        @else
                            <img height="40" width="40" class="rounded-circle" src="{{asset('website/assets/images/Avatar wrap.png')}}" alt="">
                        @endif
                                ...
                                <div class="d-flex justify-content-between">
                                    <div>
                                        @if($message['sender']['avatar'])
                                            <img height="50" width="50" class="rounded-circle" src="{{asset('uploads/pics/'. $message['sender']['avatar'])}}" alt="">
                                        @else
                                            <img height="50" width="50" class="rounded-circle" src="{{asset('website/assets/images/Avatar wrap.png')}}" alt="">
                                        @endif

<main class="main-content">
    ...
    <div class="border-div">
        <div class="b-btm flex-div-2">
            <h4>{{$page_title}}</h4>
             <a style='text-align:center' href='{{route('admin.create_car_modules')}}' class="button btn-red big">@lang('site.create')</a>
        </div>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="actions">
                                    ...
                                    <a href='{{route('admin.edit_car_modules',$record->id)}}' class="no-btn"><i

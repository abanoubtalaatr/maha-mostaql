    ...
    <main class="main-content">
      <section class="reset">
        <div class="container"><a class="back-login" href="{{route('admin.login_form')}}"><img src="{{asset('assets_'.app()->getLocale())}}/imgs/login/back-arrow.svg" alt=""><span>Go-back</span></a>

<main class="main-content">
    ...
    <div class="border-div">
        <div class="b-btm flex-div-2">
            <h4>{{$page_title}}</h4>
            <a style='text-align:center' href='{{route('admin.create_sub_services')}}' class="button btn-red big">@lang('site.create')</a>
        </div>
            ...
            @if(count($records))
                <table class="table-page table">
                    ...
                    <tr>
                        ...
                        <th class="text-center">@lang('site.time')</th>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="actions">
                                    ...
                                    <a href='{{route('admin.edit_sub_services',$record->id)}}' class="no-btn"><i
